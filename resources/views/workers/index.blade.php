...
<main class="container text-white mx-auto py-6 pt-2 px-4">
    <h1 class="text-4xl font-bold mb-8">Workers</h1>
    <a href="{{ route('workers.create') }}" class="bg-blue-300 text-white py-2 px-4 rounded-lg mb-6 inline-block">Add New Clergy</a>
