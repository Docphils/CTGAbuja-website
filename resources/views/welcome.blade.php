@include('layouts.homeheader')
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    ...
                                    <div class="absolute top-0 left-0 w-full h-full flex justify-center items-center">
                                        <div class="text-white text-center">
                                            <h1 class="text-yellow-300 text-6xl font-fugaz font-bold">Welcome to CTG</h1>
                                            <hr><br>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-blue-300 p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                            ...
                            <a
                                ...
                                class="flex items-start gap-1 rounded-lg bg-blue-300 p-2 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                            >
                                <div class="flex size-6 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-12">
                                ...
                                <div class="pt-1 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-white dark:text-white">Gallery</h2>

                                    <p class="mt-2 text-sm/relaxed text-white">
                                        <div class="container mx-auto">
                                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                                                <!-- Gallery items -->
                                                <div class="relative overflow-hidden rounded-lg shadow-md hover:shadow-xl">
                                                    <img class="w-full h-auto" src="images/fullchurch.jpg" alt="Image 1">
                                                    <div class="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition duration-300 ease-in-out bg-black bg-opacity-50">
                                                        <p class="text-white text-lg font-semibold">Image 1</p>
                                                    </div>
                                                </div>
                                                <div class="relative overflow-hidden rounded-lg shadow-md hover:shadow-xl">
                                                    <img class="w-full h-auto" src="images/fullchurch.jpg" alt="Image 2">
                                                    <div class="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition duration-300 ease-in-out bg-black bg-opacity-50">
                                                        <p class="text-white text-lg font-semibold">Image 2</p>
                                                    </div>
                                                </div>
                                                <div class="relative overflow-hidden rounded-lg shadow-md hover:shadow-xl">
                                                    <img class="w-full h-auto" src="images/fullchurch.jpg" alt="Image 3">
                                                    <div class="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition duration-300 ease-in-out bg-black bg-opacity-50">
                                                        <p class="text-white text-lg font-semibold">Image 3</p>
                                                    </div>
                                                </div>
